...
static const char *screen_shot_cmd[] = { "dmenu_run", NULL };
static const char *volume_down_cmd[] = { "dmenu_run", NULL };
static const char *term_cmd[]  = { "st", NULL };

static const Key keys[] = {
	/* modifier                     key            function                argument */
	{ MODKEY,                       XK_p,          spawn,                  {.v = dmenu_cmd } },
	{ MODKEY|ShiftMask,             XK_p,          spawn,                  {.v = dmenu_cmd } },
	{ MODKEY,                       XK_a,          spawn,                  {.v = term_cmd } },
	...
	*/
	...
	{ MODKEY|ShiftMask,             XK_i,          shiftboth,              { .i = -1 } }, // note keybinding conflict with focusadjacenttag tagtoleft
	{ MODKEY|ShiftMask,             XK_o,          shiftboth,              { .i = +1 } }, // note keybinding conflict with focusadjacenttag tagtoright
